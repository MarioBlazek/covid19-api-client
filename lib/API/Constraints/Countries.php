...
final class Countries
{
    ...
    public const COUNTRY_BAHAMAS_THE = 'bahamas-the';
    ...
    public const COUNTRY_CABO_VERDE = 'cabo-verde';
    ...
    public const COUNTRY_CHANNEL_ISLANDS = 'channel-islands';
    public const COUNTRY_CHILE = 'chile';
    public const COUNTRY_CHINA = 'china';
    public const COUNTRY_COLOMBIA = 'colombia';
    public const COUNTRY_CONGO_BRAZZAVILLE = 'congo-(brazzaville)';
    public const COUNTRY_CONGO_KINSHASA = 'congo-(kinshasa)';
    public const COUNTRY_COSTA_RICA = 'costa-rica';
    public const COUNTRY_COTE_DIVOIRE = 'cote-divoire';
    public const COUNTRY_CROATIA = 'croatia';
    public const COUNTRY_CRUISE_SHIP = 'cruise-ship';
    public const COUNTRY_CUBA = 'cuba';
    public const COUNTRY_CURACAO = 'curacao';
    ...
    public const COUNTRY_DIAMOND_PRINCESS = 'diamond-princess';
    ...
    public const COUNTRY_ESWATINI = 'eswatini';
    ...
    public const COUNTRY_GAMBIA_THE = 'gambia-the';
    ...
    public const COUNTRY_HOLY_SEE = 'holy-see';
    public const COUNTRY_HONDURAS = 'honduras';
    public const COUNTRY_HONG_KONG = 'hong-kong';
    public const COUNTRY_HONG_KONG_SAR = 'hong-kong-sar';
    ...
    public const COUNTRY_IRAN_ISLAMIC_REPUBLIC_OF = 'iran-(islamic-republic-of)';
    ...
    public const COUNTRY_KOSOVO = 'kosovo';
    ...
    public const COUNTRY_MACAO_SAR = 'macao-sar';
    public const COUNTRY_MACAU = 'macau';
    public const COUNTRY_MADAGASCAR = 'madagascar';
    public const COUNTRY_MAINLAND_CHINA = 'mainland-china';
    ...
    public const COUNTRY_NORTH_IRELAND = 'north-ireland';
    public const COUNTRY_NORTH_MACEDONIA = 'north-macedonia';
    public const COUNTRY_NORWAY = 'norway';
    public const COUNTRY_OCCUPIED_PALESTINIAN_TERRITORY = 'occupied-palestinian-territory';
    public const COUNTRY_OMAN = 'oman';
    public const COUNTRY_OTHERS = 'others';
    ...
    public const COUNTRY_REPUBLIC_OF_IRELAND = 'republic-of-ireland';
    public const COUNTRY_REPUBLIC_OF_KOREA = 'republic-of-korea';
    public const COUNTRY_REPUBLIC_OF_MOLDOVA = 'republic-of-moldova';
    public const COUNTRY_REPUBLIC_OF_THE_CONGO = 'republic-of-the-congo';
    ...
    public const COUNTRY_SAINT_BARTHELEMY = 'saint-barthelemy';
    public const COUNTRY_SAINT_KITTS_AND_NEVIS = 'saint-kitts-and-nevis';
    public const COUNTRY_SAINT_LUCIA = 'saint-lucia';
    public const COUNTRY_SAINT_MARTIN = 'saint-martin';
    ...
    public const COUNTRY_SOUTH_KOREA = 'south-korea';
    public const COUNTRY_SPAIN = 'spain';
    public const COUNTRY_SRI_LANKA = 'sri-lanka';
    public const COUNTRY_ST_MARTIN = 'st.-martin';
    ...
    public const COUNTRY_VATICAN_CITY = 'vatican-city';
    ...
    public static function getValidEntries(): array
    {
        return [
            ...
            self::COUNTRY_CHAD,
            self::COUNTRY_CHANNEL_ISLANDS,
            self::COUNTRY_CHILE,
            self::COUNTRY_CHINA,
            self::COUNTRY_COLOMBIA,
            self::COUNTRY_CONGO_BRAZZAVILLE,
            self::COUNTRY_CONGO_KINSHASA,
            self::COUNTRY_COSTA_RICA,
            self::COUNTRY_COTE_DIVOIRE,
            self::COUNTRY_CROATIA,
            self::COUNTRY_CRUISE_SHIP,
            self::COUNTRY_CUBA,
            self::COUNTRY_CURACAO,
            self::COUNTRY_CYPRUS,
            self::COUNTRY_CZECH_REPUBLIC,
            self::COUNTRY_CZECHIA,
            self::COUNTRY_DENMARK,
            self::COUNTRY_DIAMOND_PRINCESS,
            self::COUNTRY_DJIBOUTI,
            self::COUNTRY_DOMINICA,
            self::COUNTRY_DOMINICAN_REPUBLIC,
            self::COUNTRY_EAST_TIMOR,
            ...
            self::COUNTRY_GABON,
            self::COUNTRY_GAMBIA,
            self::COUNTRY_GAMBIA_THE,
            self::COUNTRY_GEORGIA,
            self::COUNTRY_GERMANY,
            self::COUNTRY_GHANA,
            self::COUNTRY_GIBRALTAR,
            self::COUNTRY_GREECE,
            ...
            self::COUNTRY_NORTH_IRELAND,
            self::COUNTRY_NORTH_MACEDONIA,
            self::COUNTRY_NORWAY,
            self::COUNTRY_OCCUPIED_PALESTINIAN_TERRITORY,
            self::COUNTRY_OMAN,
            self::COUNTRY_OTHERS,
            ...
            self::COUNTRY_QATAR,
            self::COUNTRY_REPUBLIC_OF_IRELAND,
            self::COUNTRY_REPUBLIC_OF_KOREA,
            self::COUNTRY_REPUBLIC_OF_MOLDOVA,
            self::COUNTRY_REPUBLIC_OF_THE_CONGO,
            self::COUNTRY_REUNION,
            self::COUNTRY_ROMANIA,
            self::COUNTRY_RUSSIA,
            self::COUNTRY_RUSSIAN_FEDERATION,
            self::COUNTRY_RWANDA,
            self::COUNTRY_SAINT_BARTHELEMY,
            self::COUNTRY_SAINT_KITTS_AND_NEVIS,
            self::COUNTRY_SAINT_LUCIA,
            self::COUNTRY_SAINT_MARTIN,
